...
#   RALPH_AUTOPILOT_ENABLED='true' \
#   RALPH_AUTOPILOT_MAX_ISSUES='2' \
#   AGENT_CODEX_MODEL='' \
#   AGENT_CODEX_MODEL_FAST='gpt-5.3-codex-spark' \
#   AGENT_CODEX_MODEL_COMPLEX='gpt-5.3-codex' \
#   AGENT_CODEX_COMPLEX_LABELS='risk/high,priority/p0,sev0,sev1,decision/major,area/storage,type/bug' \
#   AGENT_CODEX_SANDBOX='workspace-write' \
#   AGENT_CODEX_APPROVAL='never' \
#   AGENT_CODEX_SEARCH='true' \
#   OMX_SAFE_MODE='true' \
#   OMX_FORBIDDEN_FLAGS='--madmax,--yolo,--dangerously-bypass-approvals-and-sandbox' \
#   OMX_FORBIDDEN_SANDBOXES='danger-full-access' \
#   AGENT_AUTO_MERGE_ENABLED='true' \
#   RALPH_SELF_HEAL_ENABLED='true' \
#   AGENT_MAX_ISSUES_PER_RUN='2' \
#   AGENT_MAX_PLANNER_ISSUES_PER_RUN='1' \
#   AGENT_MAX_AUTO_RETRIES='2' \
#   AGENT_IN_PROGRESS_TIMEOUT_HOURS='6' \
#   AGENT_AUTO_CLEANUP_ENABLED='true' \
#   AGENT_DEPRECATE_DUPLICATES_ENABLED='true' \
...
#   MANAGER_MAX_SETS_PER_RUN='2' \
#   QA_ADDRESS_BATCH_SIZE='5' \
#   QA_CHAIN_TARGETS='solana-devnet,base-sepolia' \
#   SOLANA_WHITELIST_FILE='configs/solana_whitelist_addresses.txt' \
#   SOLANA_WHITELIST_CSV='...' \
#   BASE_WHITELIST_FILE='configs/base_whitelist_addresses.txt' \
#   BASE_WHITELIST_CSV='...' \
...
RALPH_AUTOPILOT_ENABLED_VALUE="${RALPH_AUTOPILOT_ENABLED:-true}"
RALPH_AUTOPILOT_MAX_ISSUES_VALUE="${RALPH_AUTOPILOT_MAX_ISSUES:-2}"
...
AGENT_CODEX_COMPLEX_LABELS_VALUE="${AGENT_CODEX_COMPLEX_LABELS:-risk/high,priority/p0,sev0,sev1,decision/major,area/storage,type/bug}"
...
OMX_SAFE_MODE_VALUE="${OMX_SAFE_MODE:-true}"
OMX_FORBIDDEN_FLAGS_VALUE="${OMX_FORBIDDEN_FLAGS:---madmax,--yolo,--dangerously-bypass-approvals-and-sandbox}"
OMX_FORBIDDEN_SANDBOXES_VALUE="${OMX_FORBIDDEN_SANDBOXES:-danger-full-access}"
AGENT_AUTO_MERGE_ENABLED_VALUE="${AGENT_AUTO_MERGE_ENABLED:-true}"
RALPH_SELF_HEAL_ENABLED_VALUE="${RALPH_SELF_HEAL_ENABLED:-true}"
...
AGENT_IN_PROGRESS_TIMEOUT_HOURS_VALUE="${AGENT_IN_PROGRESS_TIMEOUT_HOURS:-6}"
AGENT_AUTO_CLEANUP_ENABLED_VALUE="${AGENT_AUTO_CLEANUP_ENABLED:-true}"
AGENT_DEPRECATE_DUPLICATES_ENABLED_VALUE="${AGENT_DEPRECATE_DUPLICATES_ENABLED:-true}"
...
MANAGER_MAX_SETS_PER_RUN_VALUE="${MANAGER_MAX_SETS_PER_RUN:-2}"
QA_ADDRESS_BATCH_SIZE_VALUE="${QA_ADDRESS_BATCH_SIZE:-5}"
QA_CHAIN_TARGETS_VALUE="${QA_CHAIN_TARGETS:-solana-devnet,base-sepolia}"
...
BASE_WHITELIST_FILE_VALUE="${BASE_WHITELIST_FILE:-configs/base_whitelist_addresses.txt}"
BASE_WHITELIST_CSV_VALUE="${BASE_WHITELIST_CSV:-}"
...
set_repo_var "RALPH_AUTOPILOT_ENABLED" "${RALPH_AUTOPILOT_ENABLED_VALUE}"
set_repo_var "RALPH_AUTOPILOT_MAX_ISSUES" "${RALPH_AUTOPILOT_MAX_ISSUES_VALUE}"
...
set_repo_var "AGENT_CODEX_COMPLEX_LABELS" "${AGENT_CODEX_COMPLEX_LABELS_VALUE}"
...
set_repo_var "OMX_SAFE_MODE" "${OMX_SAFE_MODE_VALUE}"
set_repo_var "OMX_FORBIDDEN_FLAGS" "${OMX_FORBIDDEN_FLAGS_VALUE}"
set_repo_var "OMX_FORBIDDEN_SANDBOXES" "${OMX_FORBIDDEN_SANDBOXES_VALUE}"
set_repo_var "AGENT_AUTO_MERGE_ENABLED" "${AGENT_AUTO_MERGE_ENABLED_VALUE}"
set_repo_var "RALPH_SELF_HEAL_ENABLED" "${RALPH_SELF_HEAL_ENABLED_VALUE}"
...
set_repo_var "AGENT_IN_PROGRESS_TIMEOUT_HOURS" "${AGENT_IN_PROGRESS_TIMEOUT_HOURS_VALUE}"
set_repo_var "AGENT_AUTO_CLEANUP_ENABLED" "${AGENT_AUTO_CLEANUP_ENABLED_VALUE}"
set_repo_var "AGENT_DEPRECATE_DUPLICATES_ENABLED" "${AGENT_DEPRECATE_DUPLICATES_ENABLED_VALUE}"
...
set_repo_var "QA_CHAIN_TARGETS" "${QA_CHAIN_TARGETS_VALUE}"
set_repo_var "SOLANA_WHITELIST_FILE" "${SOLANA_WHITELIST_FILE_VALUE}"
set_repo_var "BASE_WHITELIST_FILE" "${BASE_WHITELIST_FILE_VALUE}"
...
if [ -n "${BASE_WHITELIST_CSV_VALUE}" ]; then
  set_repo_var "BASE_WHITELIST_CSV" "${BASE_WHITELIST_CSV_VALUE}"
fi
