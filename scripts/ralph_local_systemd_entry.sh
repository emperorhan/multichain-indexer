...
export RALPH_VALIDATE_MODE="${RALPH_VALIDATE_MODE:-tiered}"
export RALPH_VALIDATE_LIGHT_CMD="${RALPH_VALIDATE_LIGHT_CMD:-go test ./... -count=1}"
export RALPH_VALIDATE_FULL_EVERY="${RALPH_VALIDATE_FULL_EVERY:-3}"
...
export RALPH_AUTOMANAGER_ENABLED="${RALPH_AUTOMANAGER_ENABLED:-true}"
export RALPH_SELF_HEAL_MAX_ATTEMPTS="${RALPH_SELF_HEAL_MAX_ATTEMPTS:-1}"
export RALPH_LOG_RETENTION_ENABLED="${RALPH_LOG_RETENTION_ENABLED:-true}"
export RALPH_LOG_RETENTION_MAX_BYTES="${RALPH_LOG_RETENTION_MAX_BYTES:-2147483648}"
export RALPH_LOG_RETENTION_MAX_FILES="${RALPH_LOG_RETENTION_MAX_FILES:-1200}"
export RALPH_LOG_RETENTION_MAX_AGE_DAYS="${RALPH_LOG_RETENTION_MAX_AGE_DAYS:-14}"
export RALPH_LOG_RETENTION_COOLDOWN_SEC="${RALPH_LOG_RETENTION_COOLDOWN_SEC:-300}"
export RALPH_LOG_RETENTION_PROTECTED_MAX_BYTES="${RALPH_LOG_RETENTION_PROTECTED_MAX_BYTES:-134217728}"
export RALPH_LOG_RETENTION_PROTECTED_TAIL_BYTES="${RALPH_LOG_RETENTION_PROTECTED_TAIL_BYTES:-33554432}"
...
export RALPH_PROMPT_CONTEXT_PLANNING_FIRST_MAX_LINES="${RALPH_PROMPT_CONTEXT_PLANNING_FIRST_MAX_LINES:-120}"
export RALPH_PROMPT_CONTEXT_PLANNING_FIRST_HEAD_LINES="${RALPH_PROMPT_CONTEXT_PLANNING_FIRST_HEAD_LINES:-60}"
export RALPH_PROMPT_CONTEXT_PLANNING_FIRST_TAIL_LINES="${RALPH_PROMPT_CONTEXT_PLANNING_FIRST_TAIL_LINES:-60}"
export RALPH_PROMPT_PLANNING_FIRST_ENABLED="${RALPH_PROMPT_PLANNING_FIRST_ENABLED:-true}"
