...
alias lrstart='systemctl --user start ralph-local.service'
alias lrstop='systemctl --user stop ralph-local.service'
alias lrrestart='systemctl --user restart ralph-local.service'
alias lrstatus='systemctl --user status ralph-local.service --no-pager'
